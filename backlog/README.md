...
| --- | --- | --- | --- | --- | --- | --- | --- |
| BLG-whatsflow-channel-attendance-study | whatsflow_v2 channel and attendance study (ST-03) | Selected-for-Planning | [active planning TODO](../todos/active/features/TODO-leadshug-whatsflow-channel-attendance-study.md) | clarify attendance concepts without importing legacy debt or vocabulary collisions | three decisions validated; first critique integrated; no canonization | strategic steward | revalidate `ST03-CRIT-001..004`, renew the baseline, then repeat review gates |
