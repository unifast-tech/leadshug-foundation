...
| --- | --- | --- | --- | --- | --- | --- | --- |
| BLG-whatsflow-channel-attendance-study | whatsflow_v2 channel and attendance study (ST-03) | Selected-for-Planning | [active planning TODO](../todos/active/features/TODO-leadshug-whatsflow-channel-attendance-study.md) | clarify attendance concepts without importing legacy debt or vocabulary collisions | three decisions validated; two critique rounds integrated and revalidated; no canonization | strategic steward | publish renewed baseline and rerun pre-approval gates |
