...
No snapshot observado, o LeadsHug já apresenta o núcleo funcional comum aos dois produtos antigos: identidade única, escopo por Mantenedora/BU, canais oficial e não oficial como adaptadores, inbox única, conversa independente do transporte, claim externo/interno, encerramento/reabertura, histórico, exportação CSV, API keys e API pública de conversas. Essa presença estática não afirma saúde produtiva; ela indica que o estudo não precisa recompor os dois sistemas legados nem copiar suas árvores.

Os gaps com maior amplitude funcional observada estão em domínios ainda deliberadamente futuros no LeadsHug: ciclo de modelos oficiais, motor de campanhas/disparos, CRM, relatórios operacionais, gestão avançada de grupos/comunidades e onboarding oficial por Embedded Signup. Também apareceram extensões candidatas a estudo dentro desses domínios — mídia ponta a ponta, status de entrega/leitura/falha, custo de campanha, importação seletiva de grupos, agrupamentos reutilizáveis, assistente automatizado e central de ajuda. Essa descrição não estabelece prioridade comparativa.
...
| `legacy-hub-overlay` | `beb655cd3109fc3a537fca38c2b49f8c64853e7b` | `994e1e8ccb2ae00899c13e3e7bb103dfa7bf46c2` | `c6d99d6bb35b5e02d5178755e78ece2f087a9652` | `hub-whatsapp/backend/** hub-whatsapp/frontend/** hub-whatsapp/docs/** hub-whatsapp/docker-compose.yml hub-whatsapp/README.md hub-whatsapp/Caddyfile hub-whatsapp/.env.backend.example hub-whatsapp/.env.evolution.example hub-whatsapp/.env.example`; overlay histórico; subtree `hub-whatsapp` = `ff142200b038ae642f24c467b8f084cbc78e6229`; `hub-whatsapp/secrets/**` não admitido |

### 3.1 Comandos de verificação

```bash
git -C api-app cat-file -e '5db3fbe2043428749895fc3ff6441e9457467dd0^{commit}'
git -C api-app rev-parse 5db3fbe2043428749895fc3ff6441e9457467dd0^{tree}
git -C web-app cat-file -e '6c99c27dafdce8ed9b461d17aaaaa491b8ae16e9^{commit}'
git -C web-app rev-parse 6c99c27dafdce8ed9b461d17aaaaa491b8ae16e9^{tree}
git.exe -C "C:/Unifast/LeadsHug/Inspirações LeadsHug/Central-Whatsapp/api-oficial" cat-file -e '6517f197c97d0b5bcad886d26eb0d28a813b47ca^{commit}'
git.exe -C "C:/Unifast/LeadsHug/Inspirações LeadsHug/Central-Whatsapp/api-oficial" cat-file -e '337f3e4839cef8ca400de87b3de088a79d512944^{commit}'
git.exe -C "C:/Unifast/LeadsHug/Inspirações LeadsHug/Central-Whatsapp/api-oficial" merge-base --is-ancestor 6517f197c97d0b5bcad886d26eb0d28a813b47ca 337f3e4839cef8ca400de87b3de088a79d512944
git.exe -C "C:/Unifast/LeadsHug/Inspirações LeadsHug/Central-Whatsapp/api-oficial" rev-parse '337f3e4839cef8ca400de87b3de088a79d512944^{tree}'
...
git.exe -C "C:/Unifast/LeadsHug/Inspirações LeadsHug/Central-Whatsapp/api-oficial" rev-list --count --no-merges 6517f197c97d0b5bcad886d26eb0d28a813b47ca..337f3e4839cef8ca400de87b3de088a79d512944 -- src public migrations docs clientes package.json schema.sql wrangler.jsonc README.md CONTEXTO-CONTINUIDADE.txt
git.exe -C "C:/Unifast/LeadsHug/Inspirações LeadsHug/Central-Whatsapp/hub-whatsapp" cat-file -e '94ce80aa96d2c2ee004abc4d7ddf2c99a331def2^{commit}'
git.exe -C "C:/Unifast/LeadsHug/Inspirações LeadsHug/Central-Whatsapp/hub-whatsapp" cat-file -e '51bc16e544c7625a71c3012d8adef656c6392c37^{commit}'
git.exe -C "C:/Unifast/LeadsHug/Inspirações LeadsHug/Central-Whatsapp/hub-whatsapp" merge-base --is-ancestor 94ce80aa96d2c2ee004abc4d7ddf2c99a331def2 51bc16e544c7625a71c3012d8adef656c6392c37
git.exe -C "C:/Unifast/LeadsHug/Inspirações LeadsHug/Central-Whatsapp/hub-whatsapp" rev-parse '51bc16e544c7625a71c3012d8adef656c6392c37^{tree}'
...
git.exe -C "C:/Unifast/LeadsHug/Inspirações LeadsHug/Central-Whatsapp/hub-whatsapp" rev-list --count --no-merges 94ce80aa96d2c2ee004abc4d7ddf2c99a331def2..51bc16e544c7625a71c3012d8adef656c6392c37 -- backend frontend docs docker-compose.yml README.md Caddyfile .env.backend.example .env.evolution.example .env.example
git -C "/mnt/c/Unifast/LeadsHug/Backup LeadsHug/LeadsHug" cat-file -e 'beb655cd3109fc3a537fca38c2b49f8c64853e7b^{commit}'
git -C "/mnt/c/Unifast/LeadsHug/Backup LeadsHug/LeadsHug" cat-file -e '994e1e8ccb2ae00899c13e3e7bb103dfa7bf46c2^{commit}'
git -C "/mnt/c/Unifast/LeadsHug/Backup LeadsHug/LeadsHug" merge-base --is-ancestor beb655cd3109fc3a537fca38c2b49f8c64853e7b 994e1e8ccb2ae00899c13e3e7bb103dfa7bf46c2
git -C "/mnt/c/Unifast/LeadsHug/Backup LeadsHug/LeadsHug" rev-parse '994e1e8ccb2ae00899c13e3e7bb103dfa7bf46c2^{tree}'
git -C "/mnt/c/Unifast/LeadsHug/Backup LeadsHug/LeadsHug" rev-parse '994e1e8ccb2ae00899c13e3e7bb103dfa7bf46c2:hub-whatsapp'
...
Resultados observados: trees `4386ac3c...`, `8b83239b...`, `1ee054a4...`, `e8823e40...`, head tree legado `c6d99d6b...` e subtree `ff142200...`; os três testes de ancestralidade retornaram exit `0`. Intervalos totais: `129`, `66` e `88`; intervalos allowlisted: `126`, `64` e `1`. Os cinco commits Central restantes não tocaram allowlists.
...
| `CAP-004` | `central-official@90b733a5:migrations/023-disparo-com-fluxo.sql:commit-90b733a5`; `central-official@d294466b:src/index.js:button-report`; `central-official@234d239c:public/index.html:campaign-cost`; `central-official@fdf0d0e5:migrations/033-disparo-com-agente.sql:commit-fdf0d0e5` | `NF-004` | medir reação e encaminhar respostas | custo errado, automação invasiva e acoplamento | `CAP-003`, analytics, automação | null |
...
| `CAP-009` | `central-official@c34c418d:public/index.html:version-notice`; `central-hub@354f4116:frontend/src/components/AvisoNovaVersao.tsx:commit-354f4116` | `NF-009` | evitar sessão presa em bundle incompatível | loops de reload e falsa atualização | version fingerprint/build publication | null |
...
| `CAP-015` | `central-official@0b862ad1:migrations/019-crm.sql:commit-0b862ad1`; `central-official@6cf96922:public/index.html:crm-card-conversation` | `NF-015` | acompanhar lead da conversa ao funil | definir domínio por UI e duplicar contato | roadmap Phase 3, ADR/contrato CRM | roadmap exige definição própria; não é rejeição |
| `CAP-016` | `central-official@db218a55:migrations/027-entrega-e-leitura.sql:commit-db218a55`; `central-official@8d2c1088:migrations/028-entrega-nas-mensagens.sql:commit-8d2c1088`; `central-hub@fc73a262:backend/src/modules/webhooks/routes.ts:delivery-status` | `api-app@5db3fbe:prisma/schema.prisma:MessageStatus`; `api-app@5db3fbe:src/surfaces/webhooks/meta.controller.ts:commit-5db3fbe`; `api-app@5db3fbe:src/surfaces/webhooks/evolution.controller.ts:commit-5db3fbe` | saber se a mensagem chegou, foi lida ou falhou | estados fora de ordem e diferenças de provedor | idempotência, externalId, adapter status mapping | parcial: enum existe; processamento ponta a ponta não está completo |
...
| `CAP-021` | `central-hub@94ce80aa:backend/src/modules/groups/routes.ts:groupsRouter`; `central-hub@212dd8b3:backend/src/modules/groupBundles/routes.ts:commit-212dd8b3`; `central-hub@06f24f8b:backend/src/modules/groups/destino.ts:community` | `api-app@5db3fbe:prisma/schema.prisma:ContactType.GRUPO`; `api-app@5db3fbe:src/domain/inbox/conversations.service.ts:grupos` | operar comunicação coletiva reutilizável | banimento, consentimento, hierarquia de comunidade | policy não oficial, ST-03, rate limit/audit | parcial: inbox de grupos existe; gestão/importação/disparo não |
| `CAP-022` | `central-hub@00031957:backend/src/modules/instances/importHistory.ts:commit-00031957` | `NF-022` | continuidade ao conectar número existente | volume, duplicata, PII e ordem histórica | idempotência, cursor, retention | null |
| `CAP-023` | `central-hub@fa56ecf6:backend/src/modules/scheduling/routes.ts:edit-schedule`; `central-hub@fa56ecf6:frontend/src/components/PreviaWhatsApp.tsx:commit-fa56ecf6` | `NF-023` | revisar e corrigir envio antes de executar | corrida com worker e alteração tardia | `CAP-003`, scheduler, optimistic locking | null |
| `CAP-024` | `central-official@bfab20fd:migrations/017-modulo-consulta.sql:commit-bfab20fd`; `central-hub@34149751:backend/src/auth/access.ts:consult` | `api-app@5db3fbe:prisma/schema.prisma:Role`; `web-app@6c99c27:src/telas/Usuarios.tsx:roles`; `NF-024` | separar observação de atuação | matriz de permissão duplicada | modelo de acesso canônico | `ADR-0018` no código atual removeu `VIEWER`; descartar como papel, não a necessidade de consulta segura |
| `CAP-025` | `central-official@82250088:public/index.html:inbox-location`; `central-hub@0674d595:backend/src/modules/instances/routes.ts:rename`; `central-hub@7801d83f:frontend/src/pages/Inbox.tsx:phone-header` | `api-app@5db3fbe:prisma/schema.prisma:BusinessUnit/BuChannel`; `web-app@6c99c27:src/telas/Numeros.tsx:commit-6c99c27` | reduzir erro operacional ao escolher canal/BU | nomes divergentes e confusão BU/Setor | canonical naming and channel inventory | parcial: telefone/BU/status existem; alias/localização podem melhorar UX |
| `CAP-026` | `central-official@089374c5:public/privacidade.html:commit-089374c5`; `central-official@50c0745f:public/termos.html:commit-50c0745f`; `central-official@8edcd8f6:public/privacidade.html:data-deletion` | `NF-026` | transparência e requisitos de plataforma | texto jurídico incorreto/desatualizado | owner jurídico, privacy process | null |
...
| --- | --- | --- | --- | --- | --- | --- |
| `CAP-001` | applies: template owner is tenant-scoped | applies: WABA/channel belongs to BU | not_applicable: model definition precedes conversation | applies: Meta template adapter | applies: submission/status lifecycle | applies: Meta category/window policy |
| `CAP-002` | applies: imported model keeps tenant owner | applies: import targets BU channel | not_applicable: media header is model metadata | applies: Meta import/media adapter | applies: import/status changes | applies: Meta media/template constraints |
| `CAP-003` | applies: campaign audience is tenant data | applies: sender/list scoped to BU | applies: reply creates or continues relation | applies: official/hub send differences | applies: enqueue/send/result trail | applies: opt-in, rate and window |
| `CAP-004` | applies: response/cost isolated by tenant | applies: campaign and automation belong to BU | applies: button response links conversation | applies: interactive payload differs by provider | applies: response, routing and cost | applies: button/flow/window rules |
| `CAP-005` | applies: API key is tenant-scoped | applies: exposed IDs remain BU-scoped | applies: public API manipulates conversations | applies: send resolves channel adapter | applies: key use and mutations | applies: provider limits remain enforced |
| `CAP-006` | applies: inbox cannot cross tenant | applies: conversation visibility is BU-scoped | applies: canonical conversation is the core | applies: channel is resolved behind adapter | applies: claim/reply/close trail | applies: each transport keeps its policy |
| `CAP-007` | applies: stored media is tenant data | applies: attachment belongs to BU conversation | applies: media is a message in the thread | applies: codecs, limits and retrieval differ | applies: upload/send/failure trail | applies: provider media restrictions |
| `CAP-008` | not_applicable: presentation adds no tenant model | not_applicable: layout adds no BU rule | applies: UI navigates list and thread | not_applicable: responsive layout is provider-neutral | not_applicable: layout adds no auditable mutation | not_applicable: layout adds no channel rule |
| `CAP-009` | not_applicable: build version is global | not_applicable: notice is not BU-specific | not_applicable: no conversation behavior | not_applicable: bundle refresh is provider-neutral | applies: published build/version evidence | not_applicable: no channel decision |
| `CAP-010` | applies: timeline query is tenant-scoped | applies: thread belongs to BU | applies: pagination preserves message order | not_applicable: paging contract is provider-neutral | applies: gap/order diagnostics | not_applicable: no channel policy change |
| `CAP-011` | applies: search/export cannot cross tenant | applies: filters and exports are BU-scoped | applies: records come from conversations | not_applicable: query/export is provider-neutral | applies: export and access trail | not_applicable: no send/receive policy change |
| `CAP-012` | applies: metrics isolate tenant | applies: cuts include BU/setor | applies: journey derives from conversation events | applies: metric semantics normalize providers | applies: metric provenance | applies: channel volumes need contextual policy |
| `CAP-013` | applies: ownership cannot cross tenant | applies: assignment/transfer is BU-bound | applies: claim and transfer mutate conversation | not_applicable: ownership is transport-neutral | applies: claim/transfer trail | not_applicable: no provider policy is introduced |
| `CAP-014` | applies: close/reopen remains tenant-scoped | applies: state belongs to BU conversation | applies: lifecycle transition is conversational | not_applicable: state machine is provider-neutral | applies: close/reopen event trail | not_applicable: no channel-specific rule |
| `CAP-015` | applies: CRM record is tenant data | applies: lead/card ownership needs BU | applies: card retains origin/link to conversation | not_applicable: CRM domain is provider-neutral | applies: stage/card mutations | not_applicable: no channel policy unless future contract adds it |
| `CAP-016` | applies: status cannot cross tenant | applies: message/channel belongs to BU | applies: status attaches to conversation message | applies: provider status mapping differs | applies: ordered delivery/read/failure trail | applies: supported states depend on channel |
| `CAP-017` | applies: credential/channel owner is tenant | applies: connected number attaches to BU | not_applicable: onboarding precedes conversation | applies: Meta signup and Evolution QR differ | applies: connect/disconnect/delete trail | applies: provider onboarding/removal policy |
| `CAP-018` | applies: unified identity remains tenant-owned | applies: access resolves permitted BUs | not_applicable: login is not conversation state | applies: provider modes share one identity boundary | applies: authentication/access trail | not_applicable: identity does not replace channel policy |
| `CAP-019` | applies: bot/session cannot cross tenant | applies: automation belongs to BU/product | applies: handoff and replies mutate conversation | applies: automation transport/send adapter | applies: decisions, handoff and failures | applies: handoff, schedule and messaging window |
| `CAP-020` | not_applicable: generic help adds no tenant data | unknown: future content may vary by BU | not_applicable: help is not conversation state | not_applicable: contextual help is provider-neutral | applies: editorial/version ownership | not_applicable: no channel operation |
| `CAP-021` | applies: group/contact data is tenant-owned | applies: group operation selects BU channel | applies: group thread must stay distinct from 1:1 | applies: Evolution group/community API | applies: import/create/send trail | applies: unofficial group/community constraints |
| `CAP-022` | applies: imported history is tenant data | applies: import targets a BU channel | applies: dedupe/order affect thread | applies: Evolution history source | applies: cursor, result and failure trail | applies: retention/import limits |
| `CAP-023` | applies: schedule owner is tenant | applies: sender/list scoped to BU | applies: outbound result enters history | applies: send payload is provider-specific | applies: create/edit/execute trail | applies: timing, rate and transport constraints |
| `CAP-024` | applies: read access stays tenant-scoped | applies: visibility is BU-scoped | applies: role governs conversation read boundary | not_applicable: access role is provider-neutral | applies: read/access grants | not_applicable: role does not define channel policy |
| `CAP-025` | applies: number alias is tenant data | applies: identity exposes owning BU | applies: header locates current conversation context | applies: number identity/status comes from adapter | applies: rename/location changes | not_applicable: presentation does not change channel policy |
| `CAP-026` | applies: controller/requester identity | not_applicable: public legal pages are not BU-owned | not_applicable: no conversation lifecycle | applies: provider/platform review may require URLs | applies: deletion/request handling | applies: platform privacy requirements |
| `CAP-027` | applies: heuristic would process tenant messages | applies: filter would run in BU channel | applies: discard changes thread completeness | applies: WhatsApp Business auto-reply behavior | applies: any discard would require trace | applies: provider semantics determine false positives |
...
| `SU-4e07252238377732` | `official` | `04066ba323c64ec99b8572a7eb46da28fb2b3b11` | `CONTEXTO-CONTINUIDADE.txt` | `commit-04066ba323c6` | `commit_surface` | `[]` | `[]` | `[]` | `outside_st02: billing-scope rationale only; no messaging capability change` |
...
| `SU-87d620314b5a5b21` | `official` | `15f95a6943cf19d6e995d1d2c013181f1ffb9cc1` | `docs/README.md` | `commit-15f95a6943cf` | `commit_surface` | `[]` | `[]` | `[]` | `non_behavioral_chore: documentation-only correction for local PDF generation path` |
...
| `SU-a2a87f7e2f26fefd` | `official` | `4dc02047327e0ab8c1a80c7e0fdc53665e1f96c4` | `public/index.html` | `commit-4dc02047327e` | `commit_surface` | `[]` | `[]` | `[]` | `non_behavioral_chore: branding-only identity change` |
...
| `SU-123f0b3565594428` | `official` | `f86a46fca49f01361a8a1155a65697cb76682d34` | `public/index.html` | `commit-f86a46fca49f` | `commit_surface` | `[]` | `[]` | `[]` | `non_behavioral_chore: generic navigation layout change without catalogued behavior` |
| `SU-45588f6abf5d12b7` | `official` | `a7fc42a6a50a52be8f4920d7a691685fe2549ddf` | `public/index.html` | `commit-a7fc42a6a50a` | `commit_surface` | `[]` | `[]` | `[]` | `non_behavioral_chore: login-logo/theme branding only` |
| `SU-02d6eb4b6b91a256` | `official` | `5d66ad00e6b910fa964090f3b81f6d05ec7236b2` | `public/index.html` | `commit-5d66ad00e6b9` | `commit_surface` | `[]` | `[]` | `[]` | `non_behavioral_chore: product-name replacement only` |
| `SU-dce310684560c1cc` | `official` | `f75abaae06344e6565b3e3526de31b49334f4297` | `public/index.html` | `commit-f75abaae0634` | `commit_surface` | `[]` | `[]` | `[]` | `non_behavioral_chore: login subtitle copy change only` |
| `SU-3eada8e805d436dc` | `official` | `c670c93f47795eaac18f888f2c517a88969bd77a` | `src/index.js` | `commit-c670c93f4779` | `commit_surface` | `[]` | `[]` | `[]` | `non_behavioral_chore: product-name replacement in source text only` |
...
| `SU-17122e7d703eaea2` | `official` | `99b0150255a15bef47d37bb2986cf18ce3316337` | `CONTEXTO-CONTINUIDADE.txt` | `commit-99b0150255a1` | `commit_surface` | `[]` | `[]` | `[]` | `non_behavioral_chore: typo repair in continuity document` |
...
| `SU-87411772f6813892` | `official` | `478be4f8418de833459dd544ca054b9bb04a085a` | `schema.sql` | `commit-478be4f8418d` | `commit_surface` | `[]` | `[]` | `[]` | `generated_or_vendor: schema snapshot synchronized to already catalogued migrations` |
...
| `SU-fe3a2e0d80357ad0` | `official` | `ad30af3dce2ec6bb4b6fafc4d57205c3a33ba6bf` | `CONTEXTO-CONTINUIDADE.txt` | `commit-ad30af3dce2e` | `commit_surface` | `[]` | `[]` | `[]` | `outside_st02: deployment-installation topology note, not product capability` |
...
| `SU-1bbb215d42831a0d` | `hub` | `a118943b808bdc3d14d3f563b091e6541f737a67` | `docs/CONTINUIDADE.md` | `commit-a118943b808b` | `commit_surface` | `[]` | `[]` | `[]` | `non_behavioral_chore: continuity checkpoint only` |
...
| `SU-a00a492efdc62ce6` | `hub` | `5eee8ee438f6e8fe66d339e295bd2e879616c9c9` | `frontend/src/pages/Consultar.tsx` | `commit-5eee8ee438f6` | `commit_surface` | `[]` | `[]` | `[]` | `non_behavioral_chore: table spacing adjustment only` |
...
| `SU-3f376aa95b8b1597` | `hub` | `299915b128d9424e3eb8afcddd7f51f54d208f9e` | `docs/CONTINUIDADE.md` | `commit-299915b128d9` | `commit_surface` | `[]` | `[]` | `[]` | `non_behavioral_chore: documentation-only queue checkpoint` |
| `SU-e2a03222ae5fd77a` | `hub` | `ae05aca381db2775a218f39405baf2a7fbf54ffa` | `backend/src/modules/apiV1/routes.ts` | `commit-ae05aca381db` | `commit_surface` | `[]` | `[]` | `[]` | `non_behavioral_chore: terminology rename from student to lead only` |
| `SU-9b044cc20cdce338` | `hub` | `f4061c854407751cb3526692a6bd4e5b23cd7ce7` | `docs/CONTINUIDADE.md` | `commit-f4061c854407` | `commit_surface` | `[]` | `[]` | `[]` | `non_behavioral_chore: documentation of terminology rename only` |
...
| `SU-b575afffddc1c983` | `hub` | `97d2985b0acda870b8255411be843b29ccdf5bc0` | `frontend/src/pages/Login.tsx` | `commit-97d2985b0acd` | `commit_surface` | `[]` | `[]` | `[]` | `non_behavioral_chore: branding-only identity change` |
| `SU-dbfe88990545738e` | `hub` | `83c6425b8e68089a589d48920b758b596da75970` | `frontend/src/components/Layout.tsx` | `commit-83c6425b8e68` | `commit_surface` | `[]` | `[]` | `[]` | `non_behavioral_chore: generic sidebar layout change without catalogued behavior` |
| `SU-15280bf571fe4c85` | `hub` | `0e0f201ea96632ed97dc7798008b2b04ea97aece` | `frontend/src/pages/Login.tsx` | `commit-0e0f201ea966` | `commit_surface` | `[]` | `[]` | `[]` | `non_behavioral_chore: login-logo/theme branding only` |
| `SU-8471e91484555b06` | `hub` | `2a894c429ea612f0906db212bb72e90600a8d888` | `frontend/src/components/Layout.tsx` | `commit-2a894c429ea6` | `commit_surface` | `[]` | `[]` | `[]` | `non_behavioral_chore: comment-only sibling-product rename` |
| `SU-c766819a019f0595` | `hub` | `fdb0f0989ef10608217e9cbb4c29ed8241aa9716` | `backend/src/modules/apiV1/routes.ts` | `commit-fdb0f0989ef1` | `commit_surface` | `[]` | `[]` | `[]` | `non_behavioral_chore: backend comment-only sibling-product rename` |
...
- As 97 referências de evidência publicadas seguem `repo@sha:path:locator`, sem path agrupado; as 162 células da matriz de policy têm enum e justificativa/evidência explícita.
...
- As 27 exclusões identificam uma razão permitida e um rationale específico da unidade; nenhuma conserva o antigo boilerplate ambíguo de quatro alternativas.
