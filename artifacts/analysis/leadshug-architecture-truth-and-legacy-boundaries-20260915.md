...
| `Central-Whatsapp/api-oficial` | Independent repo `unifast-tech/api-oficial`, `main`, head `9368421`, 2026-09-11 | **Independent legacy/reference repository** | Out of LeadsHug write scope; policy: `policies/central_whatsapp_independent_legacy_policy.md` | Behavioral requirements for official templates, campaign lifecycle and Meta constraints | Formally retained as independent legacy/reference; no archive, freeze, deployment or ownership action is authorized |
| `Central-Whatsapp/hub-whatsapp` | Independent repo `unifast-tech/hub-whatsapp`, `main`, head `51bc16e`, 2026-09-10 | **Independent legacy/reference repository** | Out of LeadsHug write scope; policy: `policies/central_whatsapp_independent_legacy_policy.md` | Behavioural requirements for unofficial connection, groups, inbox assignment, rate controls and recovery | Formally retained as independent legacy/reference; no archive, freeze, deployment or ownership action is authorized |
...
1. **Central-Whatsapp policy — resolved:** the user formally retains the two repositories as independent legacy/reference systems for inspiration. The canonical policy is `policies/central_whatsapp_independent_legacy_policy.md`; it does not authorize freeze, archival, deployment, code change, data synchronization or ownership transfer.
