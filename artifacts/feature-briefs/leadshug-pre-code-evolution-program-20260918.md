...
| `ST-02` | Produzir um catálogo de diferenças de capacidade entre LeadsHug e Central-Whatsapp. | integrations-and-channels | inbox-and-conversations, audit-and-history, futuro CRM | Cada capacidade relevante tem evidência, estado no LeadsHug, valor, risco, dependência e disposição; nenhum código é portado. | Amostragem bidirecional entre catálogo, código/documentação dos três produtos e arquitetura vigente. | [Catálogo em assurance](../analysis/leadshug-central-whatsapp-capability-gap-catalog-20260925.md) e [TODO ativo](../../todos/active/features/TODO-leadshug-central-whatsapp-capability-study.md) | Baseline `AMB-06` resolvida; gates de delivery/closeout em curso. | Candidato de entrega com 27 capacidades e 204 unidades-fonte; priorização permanece no ST-04. |
...
| `ST-04` | Sintetizar os estudos em mapa de capacidades, decisões e sequência de evolução do LeadsHug. | system roadmap | módulos e contracts | O roadmap passa a apontar para capacidades e decisões priorizadas, com dependências e critérios de saída; candidatos não aprovados permanecem fora de `todos/active/`. | Revisão de rastreabilidade: cada prioridade volta à evidência e avança para um TODO apenas quando aprovada. | [`BLG-leadshug-evolution-synthesis`](../../backlog/README.md) | ST-01 concluído; ST-02 em assurance; ST-03 pendente. | É a convergência do programa, não uma implementação de produto. |
