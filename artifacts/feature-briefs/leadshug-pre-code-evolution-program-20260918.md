...
No recorte congelado e revalidado pelo ST-02, os dois repositórios somam 195 commits não-merge pós-baseline (129 oficial e 66 hub), além de um commit do overlay legado analisado separadamente. A comparação foi, portanto, feita por capacidade e comportamento, não por arquivo. Os principais grupos candidatos ao estudo são:
...
| `ST-02` | Produzir um catálogo de diferenças de capacidade entre LeadsHug e Central-Whatsapp. | integrations-and-channels | inbox-and-conversations, audit-and-history, futuro CRM | Cada capacidade relevante tem evidência, estado no LeadsHug, valor, risco, dependência e disposição; nenhum código é portado. | Amostragem bidirecional entre catálogo, código/documentação dos três produtos e arquitetura vigente. | [Catálogo concluído](../analysis/leadshug-central-whatsapp-capability-gap-catalog-20260925.md) e [TODO concluído](../../todos/completed/features/TODO-leadshug-central-whatsapp-capability-study.md) | Concluído; baseline `AMB-06` resolvida no manifesto congelado. | Entregue com 27 capacidades e 204 unidades-fonte; priorização permanece no ST-04. |
| `ST-03` | Modelar conceitualmente canais, filas/equipes e formas de atendimento a partir das lições do whatsflow_v2. | inbox-and-conversations | integrations-and-channels, identity-and-tenancy, audit-and-history | Diagrama conceitual, cardinalidades, vocabulário, invariantes, estados, roteamento, autorização e anti-padrões são documentados; nenhuma decisão é silenciosamente canonizada. | Cenários de entrada, atribuição, capacidade, transferência, SLA, múltiplas BUs e isolamento entre Mantenedoras. | [Modelo conceitual concluído](../analysis/leadshug-whatsflow-channel-attendance-conceptual-model-20260925.md) e [TODO em closeout](../../todos/active/features/TODO-leadshug-whatsflow-channel-attendance-study.md) | Conteúdo concluído e em final review; nenhuma recomendação foi canonizada, priorizada ou autorizada para implementação. | Entrada factual do ST-04 somente após o closeout. |
| `ST-04` | Sintetizar os estudos em mapa de capacidades, decisões e sequência de evolução do LeadsHug. | system roadmap | módulos e contracts | O roadmap passa a apontar para capacidades e decisões priorizadas, com dependências e critérios de saída; candidatos não aprovados permanecem fora de `todos/active/`. | Revisão de rastreabilidade: cada prioridade volta à evidência e avança para um TODO apenas quando aprovada. | [`BLG-leadshug-evolution-synthesis`](../../backlog/README.md) | ST-01/ST-02 concluídos; conteúdo ST-03 concluído e em closeout. Framing/refinement de ST-04 requer ciclo próprio após o fechamento. | É a convergência do programa, não uma implementação de produto. |
